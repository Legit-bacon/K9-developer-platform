float leg0A1Offset = 0;
float leg1A1Offset = 0;
float leg2A1Offset = -25;
float leg3A1Offset = -2.5;

float leg0A2Offset = -17.5;
float leg1A2Offset = -2.5;
float leg2A2Offset = -5;
float leg3A2Offset = -20;

float leg0A3Offset = 2.5;
float leg1A3Offset = 0;
float leg2A3Offset = 6;
float leg3A3Offset = -2.5;
...
class IK{
  ...
  void update(){
    ...
    if(legNo == 0){
     targetX = leg0TargetX;
     targetY = leg0TargetY+leg0Zoffset;
     targetZ = leg0TargetZ;
    }
    else if(legNo == 1){
     targetX = leg1TargetX;
     targetY = leg1TargetY+leg1Zoffset;
     targetZ = leg1TargetZ;
    }
    else if(legNo == 2){
     targetX = leg2TargetX;
     targetY = leg2TargetY+leg2Zoffset;
     targetZ = leg2TargetZ;
    }
    else if(legNo == 3){
     targetX = leg3TargetX;
     targetY = leg3TargetY+leg3Zoffset;
     targetZ = leg3TargetZ;
    } 
    ...
    upArmPos.set(targetX, (targetY + (d0-d1)), legZ);
     ...
     myPort.write(0xFF);
     if(legNo == 0){ 
       servo1 = int(map(a1+leg0A1Offset,0,120,254,0));
       myPort.write(0x02);
     }
     else if(legNo == 1){
       servo1 = int(map(a1+leg1A1Offset,0,120,254,0));
       myPort.write(0x09);
     }
     else if(legNo == 2){
       servo1 = int(map(a1+leg2A1Offset,0,120,0,254));
       myPort.write(0x08);
     }
     else if(legNo == 3){
       servo1 = int(map(a1+leg3A1Offset,0,120,0,254));
       myPort.write(0x03);
     }
     ...
     myPort.write(0xFF);
     if(legNo == 0){  
       servo2 = int(map(a2+leg0A2Offset,0,120,254,0));
       myPort.write(0x01); 
     }
     else if(legNo == 1){
       servo2 = int(map(a2+leg1A2Offset,0,120,254,0));
       myPort.write(0x0A);
     }
     else if(legNo == 2){
       servo2 = int(map(a2+leg2A2Offset,0,120,0,254));
       myPort.write(0x07);
     }
     else if(legNo == 3){
       servo2 = int(map(a2+leg3A2Offset,0,120,0,254));
       myPort.write(0x04);
     } 
     ...
     myPort.write(0xFF);
     if(legNo == 0){  
       servo3 = int(map(a3+leg0A3Offset,0,120,0,254));
       myPort.write(0x00); 
     }
     else if(legNo == 1){
       servo3 = int(map(a3+leg1A3Offset,0,120,0,254));
       myPort.write(0x0B);
     }
     else if(legNo == 2){
       servo3 = int(map(a3+leg2A3Offset,0,120,0,254));
       myPort.write(0x06);
     }
     else if(legNo == 3){
       servo3 = int(map(a3+leg3A3Offset,0,120,0,254));
       myPort.write(0x05);
     }  
